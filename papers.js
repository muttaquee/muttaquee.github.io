...
window.PUBLICATIONS = [
  ...
  },
  {
    ...
    cvVenue: "Journal on Multimodal User Interfaces",
    details: "",
    doi: "",
    status: "Under Review",
    peerReviewed: false,
  ...
  },
  {
    ...
    cvVenue: "Behaviour & Information Technology",
    details: "",
    doi: "",
    status: "Under Review",
    peerReviewed: false,
  ...
  {
    year: "2026",
    title: "Perceptions and Barriers in Workplace Artificial Intelligence Adoption Among Industry Professionals: A Cross-Sectional Descriptive Survey",
    authors: ["Iqbal, M. Z.", "Talukder, M. G. M."],
    myAuthorName: "Talukder, M. G. M.",
    type: "Journal Article",
    venue: "Computers",
    cvVenue: "Computers (MDPI)",
    details: "15(9), 596.",
    doi: "10.3390/computers15090596",
    peerReviewed: true,
    selected: true,
  },
  {
    year: "2026",
    title: "A Systematic Review of Machine Learning Ensembles and Feature Selection for Myocardial Infarction Prediction",
    authors: [],
    myAuthorName: "Talukder, M. G. M.",
    type: "Journal Article",
    venue: "PeerJ Computer Science",
    cvVenue: "PeerJ Computer Science",
    details: "",
    doi: "",
    status: "Under Review",
    peerReviewed: false,
  ...
  {
    year: "2027",
    title: "ENGAGE Approach: Using LLM-Driven, Environment-Acting Generative Virtual Sales Agents to Raise Brand Engagement in Immersive Showrooms",
    authors: [],
    myAuthorName: "Talukder, M. G. M.",
    type: "Conference Paper",
    venue: "IEEE VR 2027",
    cvVenue: "IEEE Conference on Virtual Reality and 3D User Interfaces (IEEE VR 2027)",
    details: "",
    doi: "",
    status: "Under Review",
    peerReviewed: false,
